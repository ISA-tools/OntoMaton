...
- we extended the ontology search functionality to support REST services from the <a href="https://lov.linkeddata.es/">Linked Open Vocabularies</a> and the <a href="https://www.ebi.ac.uk/ols/">EBI Ontology Lookup Service</a>, and the <a href="https://service.tib.eu/ts4tib/api">TIB Terminology Service</a>, thus now allowing ontology term searches over several separate services.
